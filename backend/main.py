...
MOLECULE_PRESETS = {
    ...
    "methane": {
        "name": "Methane (CH₄)",
        "atom": "C 0.0 0.0 0.0; H 0.6276 0.6276 0.6276; H -0.6276 -0.6276 0.6276; H -0.6276 0.6276 -0.6276; H 0.6276 -0.6276 -0.6276",
        "basis": "6-31g",
        "ncas": 4, "nelecas": 4,
    },
    "ammonia": {
        "name": "Ammonia (NH₃)",
        "atom": "N 0.0 0.0 0.0; H 0.0 -0.937 -0.383; H 0.812 0.469 -0.383; H -0.812 0.469 -0.383",
        "basis": "6-31g",
        "ncas": 4, "nelecas": 4,
    },
    "formaldehyde": {
    ...
    "acetylene": {
        "name": "Acetylene (C₂H₂)",
        "atom": "C 0.0 0.0 0.6; C 0.0 0.0 -0.6; H 0.0 0.0 1.664; H 0.0 0.0 -1.664",
        "basis": "6-31g",
        "ncas": 4, "nelecas": 4,
    },
    "benzene": {
        "name": "Benzene (C₆H₆)",
        "atom": "C 0.0 1.396 0.0; C 1.209 0.698 0.0; C 1.209 -0.698 0.0; C 0.0 -1.396 0.0; C -1.209 -0.698 0.0; C -1.209 0.698 0.0; H 0.0 2.480 0.0; H 2.148 1.240 0.0; H 2.148 -1.240 0.0; H 0.0 -2.480 0.0; H -2.148 -1.240 0.0; H -2.148 1.240 0.0",
        "basis": "sto-3g",
        "ncas": 6, "nelecas": 6,
    },
    "methanol": {
        "name": "Methanol (CH₃OH)",
        "atom": "C 0.0428 0.6625 0.0; O 0.0428 -0.7557 0.0; H -0.3072 1.0929 0.9289; H -0.3072 1.0929 -0.9289; H 1.0970 0.9735 0.0; H -0.8782 -1.0271 0.0",
        "basis": "6-31g",
        "ncas": 4, "nelecas": 4,
    },
    "carbon_dioxide": {
        "name": "Carbon Dioxide (CO₂)",
        "atom": "C 0.0 0.0 0.0; O 0.0 0.0 1.162; O 0.0 0.0 -1.162",
        "basis": "6-31g",
        "ncas": 4, "nelecas": 4,
    },
    "nitrogen": {
